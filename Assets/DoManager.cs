...
public class DoManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Do");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.doScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.doScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.doScore, false);
        }
