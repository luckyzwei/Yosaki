...
public class UiBlackTortoiseDescription : MonoBehaviour
{
    [SerializeField]
    ...
    public void Initialize(int idx)
    {
        ...
        var tableData = TableManager.Instance.sasinsuTable.dataArray[idx];

        unlockDesc.SetText($"{Utils.ConvertBigNum(tableData.Score[idx])}");
        ...
        abilDescription.SetText($"{CommonString.GetStatusName((StatusType)tableData.Abiltype0[idx])}{Utils.ConvertBigNum(tableData.Abilvalue0[idx] * 100f)}");
    ...
    public void OnClickLeftButton()
    {
        ...
        currentIdx = Mathf.Clamp(currentIdx, 0, TableManager.Instance.sasinsuTable.dataArray.Length - 1);    
    ...
    {
        if (currentIdx == TableManager.Instance.sasinsuTable.dataArray.Length - 1)
        {
