...
public class UiEquipmentCollectionPassBuyButton : MonoBehaviour
{
    [SerializeField]
    ...
    public static readonly string collectionPassKey = "collectionpass";
    ...
    private void Subscribe()
    {
        ...
        ServerData.iapServerTable.TableDatas[collectionPassKey].buyCount.AsObservable().Subscribe(e =>
        {
    ...
    {
        if (ServerData.iapServerTable.TableDatas[collectionPassKey].buyCount.Value >= 1)
        {
        ...
        GetPackageItem(collectionPassKey);
        return;
#endif

        IAPManager.Instance.BuyProduct(collectionPassKey);
    }
  ...
  public void GetPackageItem(string productId)
    {
        ...
        if (tableData.Productid != collectionPassKey) return;
