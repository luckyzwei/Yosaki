...
public class DailyPassServerTable
{
    ...
    public static string DailypassFreeReward = "Free_new";
    public static string DailypassAdReward = "Ad_new";
...
public class MonthlyPassServerTable
{
    ...
    public static string MonthlypassFreeReward = "f2";
    public static string MonthlypassAdReward = "a2";
...
public class MonthlyPassServerTable2
{
    ...
    public static string MonthlypassFreeReward = "MonthlyPassFreeReward_1";
    public static string MonthlypassAdReward = "MonthlyPasspassAdReward_1";
