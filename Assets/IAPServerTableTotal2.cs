...
public class IAPServerTableTotal2 
{
    //public static string Indate;
    //public static string tableName = "IAPHistoryTotal2";
    ...
    //            {
    //                defultValues.Add(table[i].Productid, $"{table[i].Id},{ServerData.iAPServerTableTotal.TableDatas[table[i].Productid].buyCount.Value}");

    //                var iapData = new IAPServerData();
    //                iapData.id = table[i].Id;
    //                iapData.buyCount = new ReactiveProperty<int>(ServerData.iAPServerTableTotal.TableDatas[table[i].Productid].buyCount.Value);
