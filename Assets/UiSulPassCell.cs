...
public class UiSulPassCell : MonoBehaviour
{
    [SerializeField]
    ...
    private void Subscribe()
    {
        ...
        //무료보상 데이터 변경시
        ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_Free_Key].Subscribe(e =>
        {
        ...
        //광고보상 데이터 변경시
        //ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_IAP_Key].Subscribe(e =>
        //{
        ...
        //킬카운트 변경될때
        ServerData.goodsTable.GetTableData(GoodsTable.SulItem).AsObservable().Subscribe(e =>
        {
    ...
    {
        descriptionText.SetText($"{Utils.ConvertBigNum(passInfo.require)}이상");
    }
    ...
    public void OnClickFreeRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"{CommonString.GetItemName(Item_Type.SulItem)}가 부족합니다.");
            return;
        }
    ...
    public void OnClickAdRewardButton()
    {
        ...
        {
            PopupManager.Instance.ShowAlarmMessage($"출석권이 필요합니다.");
        }
    }
    ...
    {
        //로컬
        ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_Free_Key].Value += $",{passInfo.id}";
        ...
        passParam.Add(passInfo.rewardType_Free_Key, ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_Free_Key].Value);
        transactionList.Add(TransactionValue.SetUpdate(SulPassServerTable.tableName, SulPassServerTable.Indate, passParam));
    ...
    {
        //로컬
        ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_IAP_Key].Value += $",{passInfo.id}";
        ...
        //패스 보상
        Param passParam = new Param();
        passParam.Add(passInfo.rewardType_IAP_Key, ServerData.sulPassServerTable.TableDatas[passInfo.rewardType_IAP_Key].Value);
        transactionList.Add(TransactionValue.SetUpdate(SulPassServerTable.tableName, SulPassServerTable.Indate, passParam));
    ...
    {
        int sulItemCount = (int)ServerData.goodsTable.GetTableData(GoodsTable.SulItem).Value;
        return sulItemCount >= passInfo.require;
    }
