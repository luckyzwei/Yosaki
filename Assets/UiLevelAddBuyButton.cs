...
public class UiLevelAddBuyButton : MonoBehaviour
{
    ...
    public static readonly string item_key = "growthadd";
    ...
    private void Subscribe()
    {
        ...
        ServerData.iapServerTable.TableDatas[item_key].buyCount.AsObservable().Subscribe(e =>
        {
            descText.SetText(e >= 1 ? "구매완료" : "보상권 구매");
    ...
    {
        if (ServerData.iapServerTable.TableDatas[item_key].buyCount.Value >= 1)
        {
        ...
        GetPackageItem(item_key);
        return;
#endif

        IAPManager.Instance.BuyProduct(item_key);
    }
    ...
    public void GetPackageItem(string productId)
    {
        ...
        if (tableData.Productid != item_key) return;
