...
public class YumManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Yum");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.yumScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.yumScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.yumScore, false);
        }
