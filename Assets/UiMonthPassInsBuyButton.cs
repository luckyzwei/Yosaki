...
public class UiMonthPassInsBuyButton : MonoBehaviour
{
    [SerializeField]
    ...
    public static readonly string monthInsPassKey = "monthpass13ins";
    ...
    public void GetPackageItem(string productId)
    {
        ...
        ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotal).Value += killAddAmount;

        ServerData.userInfoTable.UpData(UserInfoTable.killCountTotal, false);
