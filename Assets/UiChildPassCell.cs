...
public class UiChildPassCell : MonoBehaviour
{
    [SerializeField]
    ...
    private void GetFreeReward()
    {
        ...
        userInfoParam.Add(UserInfoTable.killCountTotalChild, ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalChild).Value);
    ...
    {
        int killCountTotalChild = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalChild).Value;
