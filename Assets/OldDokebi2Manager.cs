...
public class OldDokebi2Manager : SingletonMono<OldDokebi2Manager>
{
    [SerializeField]
    ...
    {
        int lastStage = (int)ServerData.userInfoTable.TableDatas[UserInfoTable.oldDokebi2LastClear].Value - 5;
    ...
    {
        return currentWave.Value >= TableManager.Instance.OldDokebiTable.dataArray.Length - 1;
    }
    ...
    {
        return TableManager.Instance.OldDokebiTable.dataArray[currentWave.Value].Spawnnum;
    }
    ...
    public EnemyTableData GetEnemyTableData(EnemyType enemyType)
    {
        ...
        var tableData = TableManager.Instance.OldDokebiTable.dataArray[currentWave.Value];
    ...
    private void SpawnEnemies()
    {
        ...
        for (int i = 0; i < spawnCount; i++)
        {
            ...
            EnemyType enemyType = EnemyType.Fly_Damage;

            var enemyObject = BattleObjectManager.Instance.GetItem($"OldDokebi2/{enemyType.ToString()}") as Enemy;
...
//#endif
    ...
    private void EndGame()
    {
        ...
        {
            int pref = (int)ServerData.userInfoTable.TableDatas[UserInfoTable.oldDokebi2LastClear].Value;

            int updateValue = currentWave.Value - 1;

            if (updateValue > pref)
            {
                ServerData.userInfoTable.UpData(UserInfoTable.oldDokebi2LastClear, updateValue, false);
            }
        ...
        {
            ServerData.userInfoTable.UpData(UserInfoTable.oldDokebi2LastClear, currentWave.Value, false);
