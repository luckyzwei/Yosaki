...
public class RankTable_Boss
{
    public static string Indate;
    public const string tableName_Boss = RankManager.Rank_Boss;

    public void Initialize()
    {
        SendQueue.Enqueue(Backend.GameData.GetMyData, tableName_Boss, new Where(), callback =>
        {
            // 이후 처리
            if (callback.IsSuccess() == false)
            {
            ...
            if (rows.Count <= 0)
            {
                ...
                var bro = Backend.GameData.Insert(tableName_Boss, defultValues);
...
public class RankTable_Real_Boss
{
    public static string Indate;
    public const string tableName_Boss = RankManager.Rank_Real_Boss;
...
public class RankTable_Real_Boss_GangChul
{
    public static string Indate;
    public const string tableName_Boss = RankManager.Rank_GangChul;
...
public class RankTable_YoguiSogul
{
    ...
    public void Initialize()
    {
        SendQueue.Enqueue(Backend.GameData.GetMyData, tableName_YoguiSogul, new Where(), callback =>
        {
            // 이후 처리
            if (callback.IsSuccess() == false)
            {
...
public class RankTable_ChunmaTop
{
    public static string Indate;
    public const string tableName_Boss = RankManager.Rank_ChunmaTop;
