    ...
    public static void AddLocalValue(Item_Type type, float rewardValue)
    {
        switch (type)
        {
            ...
            case Item_Type.Ticket:
                DatabaseManager.goodsTable.GetTableData(GoodsTable.Ticket).Value += rewardValue;
                break;
            case Item_Type.costume1:
                DatabaseManager.costumeServerTable.TableDatas[type.ToString()].hasCostume.Value = true;
                break;
            default:
                {
    ...
    public static TransactionValue GetItemTypeTransactionValue(Item_Type type)
    {
        ...
        switch (type)
        {
            ...
            case Item_Type.GrowThStone:
                ...
                break;
            case Item_Type.Memory:
                passParam.Add(StatusTable.Memory, DatabaseManager.statusTable.GetTableData(StatusTable.Memory).Value);
            ...
            case Item_Type.costume1:
                ...
                passParam.Add(costumeKey, DatabaseManager.costumeServerTable.TableDatas[costumeKey].ConvertToString());
    ...
    public static TransactionValue GetItemTypeTransactionValueForAttendance(Item_Type type, int amount)
    {
        ...
        switch (type)
        {
            ...
            case Item_Type.Memory:
                ...
                param.Add(StatusTable.Memory, DatabaseManager.statusTable.GetTableData(StatusTable.Memory).Value);
            ...
            case Item_Type.Ticket:
                ...
                param.Add(GoodsTable.Ticket, DatabaseManager.goodsTable.GetTableData(GoodsTable.Ticket).Value);
                return TransactionValue.SetUpdate(GoodsTable.tableName, GoodsTable.Indate, param);
            case Item_Type.costume1:
            case Item_Type.costume4:
                {
                    string costumeKey = type.ToString();
                    DatabaseManager.costumeServerTable.TableDatas[costumeKey].hasCostume.Value = true;
                    param.Add(costumeKey, DatabaseManager.costumeServerTable.TableDatas[costumeKey].ConvertToString());
            ...
            case Item_Type.weapon16:
                {
                    ...
                    DatabaseManager.weaponTable.TableDatas[key].hasItem.Value = 1;
                    DatabaseManager.weaponTable.TableDatas[key].amount.Value += amount;

                    param.Add(key, DatabaseManager.weaponTable.TableDatas[key].ConvertToString());
            ...
            case Item_Type.magicBook11:
                {
                    string key = type.ToString();
                    DatabaseManager.magicBookTable.TableDatas[key].hasItem.Value = 1;
                    DatabaseManager.magicBookTable.TableDatas[key].amount.Value += amount;

                    param.Add(key, DatabaseManager.magicBookTable.TableDatas[key].ConvertToString());
