...
public class SkillServerTable
{
    ...
    public float GetSkillDamagePer(int idx, int addLevel = 0, bool applySkillDamAbility = true)
    {
        ...
        if (tableData.Skilltype == 0 || tableData.Skilltype == 1 || tableData.Skilltype == 2 || tableData.Skilltype == 4 || tableData.Skilltype == 5 || tableData.Skilltype == 6 || tableData.Skilltype == 7)
        {
