...
public class UiPetView : MonoBehaviour
{
    ...
    public void Initialize(PetTableData petData)
    {
        ...
        normalPetObject.SetActive(petData.Id < 12 || petData.Id == 14 || petData.Id == 15 || petData.Id == 16 || petData.Id == 17);
    ...
    private void UpdateUi()
    {
        ...
        else if (petData.PETGETTYPE == PetGetType.Evolution)
        {
            ...
            else
            {
                ...
                if (petData.Id == 14|| petData.Id == 15 || petData.Id == 16 || petData.Id == 17)
                {
    ...
    public void OnClickGetButton()
    {
        ...
        else if (petData.PETGETTYPE == PetGetType.Evolution)
        {
            ...
            {
                if (petServerData.idx == 14|| petServerData.idx == 15 || petServerData.idx == 16 || petServerData.idx == 17)
                {
