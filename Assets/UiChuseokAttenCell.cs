...
public class UiChuseokAttenCell : MonoBehaviour
{
    [SerializeField]
    ...
    {
        int attenCountChuSeok = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.attenCountChuSeok).Value;
        return attenCountChuSeok >= passInfo.require;
    }
