...
public class UiSnakeAbilUpgrade : MonoBehaviour
{
    ...
    private void Subscribe()
    {
        yomulServerData.level.AsObservable().Subscribe(e =>
        {
            ...
            abilDescription.SetText($"{CommonString.GetStatusName((StatusType)yomulAbilData.Abiltype)} {PlayerStats.GetYomulUpgradeValue(StatusType.SuperCritical1DamPer) * 100f}");
