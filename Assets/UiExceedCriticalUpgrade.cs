...
public class UiExceedCriticalUpgrade : MonoBehaviour
{
    ...
    private void Subscribe()
    {
        yomulServerData.level.AsObservable().Subscribe(e =>
        {
            ...
            abilDescription.SetText($"{CommonString.GetStatusName((StatusType)yomulAbilData.Abiltype)} {PlayerStats.GetYomulUpgradeValue(StatusType.SuperCritical1Prob,onlyType1:true) * 100f}" + $"\n(일정 확률로 {PlayerStats.GetSuperCriticalDamPer() * 100f}%의 추가 데미지)");
