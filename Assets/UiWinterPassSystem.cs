...
public class UiWinterPassSystem : MonoBehaviour
{
    [SerializeField]
    private UiWinterPassCell uiPassCellPrefab;

    [SerializeField]
    private Transform cellParent;

    private List<UiWinterPassCell> uiPassCellContainer = new List<UiWinterPassCell>();
    ...
    private void Initialize()
    {
        ...
        {
            var prefab = Instantiate<UiWinterPassCell>(uiPassCellPrefab, cellParent);
    ...
    {
        bool hasIapProduct = ServerData.iapServerTable.TableDatas[UiWinterPassBuyButton.productKey].buyCount.Value > 0;
