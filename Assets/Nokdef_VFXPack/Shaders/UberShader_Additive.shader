	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break2_g145 = ( tex2D( _MainTex, panner177 ) * _MainTextureChannel );
				float4 appendResult11_g145 = (float4(break2_g145.x , break2_g145.y , break2_g145.z , break2_g145.w));
				float4 MainTexInfo180 = appendResult11_g145;
				...
				float4 break2_g146 = ( tex2DNode211 * _DetailMultiplyChannel );
				...
				ifLocalVar238 = appendResult11_g146;
				...
				float temp_output_4_0_g141 = _FlipbooksColumsRows.x;
				float temp_output_5_0_g141 = _FlipbooksColumsRows.y;
				float2 appendResult7_g141 = (float2(temp_output_4_0_g141 , temp_output_5_0_g141));
				float totalFrames39_g141 = ( temp_output_4_0_g141 * temp_output_5_0_g141 );
				float2 appendResult8_g141 = (float2(totalFrames39_g141 , temp_output_5_0_g141));
				float clampResult42_g141 = clamp( texCoord218.x , 0.0001 , ( totalFrames39_g141 - 1.0 ) );
				float temp_output_35_0_g141 = frac( ( ( (float)0 + clampResult42_g141 ) / totalFrames39_g141 ) );
				float2 appendResult29_g141 = (float2(temp_output_35_0_g141 , ( 1.0 - temp_output_35_0_g141 )));
				float2 temp_output_15_0_g141 = ( ( ( LocalUVOffset197 + uv_AlphaOverride ) / appendResult7_g141 ) + ( floor( ( appendResult8_g141 * appendResult29_g141 ) ) / appendResult7_g141 ) );
				float2 panner227 = ( 1.0 * _Time.y * _AlphaOverridePanning + temp_output_15_0_g141);
				float4 break2_g142 = ( tex2D( _AlphaOverride, panner227 ) * _AlphaOverrideChannel );
				float AlphaOverride234 = saturate( ( break2_g142.x + break2_g142.y + break2_g142.z + break2_g142.w ) );
				float2 panner226 = ( 1.0 * _Time.y * _MainAlphaPanning + temp_output_225_0);
				float4 break2_g143 = ( tex2D( _MainTex, panner226 ) * _MainAlphaChannel );
				float MainAlpha233 = saturate( ( break2_g143.x + break2_g143.y + break2_g143.z + break2_g143.w ) );
				...
				float temp_output_3_0_g144 = ( texCoord171.w - ( 1.0 - temp_output_169_0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( IN.ase_color * float4( ( desaturateVar175 + AdditiveNoise245 ) , 0.0 ) * ( texCoord184.z + 1.0 ) * float4( MultiplyNoise246 , 0.0 ) ) * ( IN.ase_color.a * temp_output_169_0 * saturate( saturate( ( temp_output_3_0_g144 / fwidth( temp_output_3_0_g144 ) ) ) ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18912
235;366;1920;1023;536.1657;1024.511;1.350089;True;False
...
Node;AmplifyShaderEditor.FunctionNode;172;218.8035,-224.0667;Inherit;False;Step Antialiasing;-1;;144;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;179;-1552.326,-635.9854;Inherit;False;Channel Picker;-1;;145;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;247;37.09401,-1359.597;Inherit;False;Channel Picker;-1;;146;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;231;-1568.326,-1291.986;Inherit;False;Channel Picker Alpha;-1;;143;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;232;-1651.099,-2338.74;Inherit;False;Channel Picker Alpha;-1;;142;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;224;-2421.211,-2274.714;Inherit;False;Flipbook;-1;;141;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
WireConnection;255;1;188;0
WireConnection;250;2;255;0
ASEEND*/
//CHKSM=E6481A0C94C50AD266BDD25EE5D468526C0B08E6