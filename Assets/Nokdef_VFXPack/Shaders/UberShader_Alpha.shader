...
Shader "Nokdef/Alpha Uber Shader"
{
	Properties
	{
		...
		[ASEEnd]_DetailAdditiveChannel("Detail Additive Channel", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_4_0_g115 = _FlipbooksColumsRows.x;
				float temp_output_5_0_g115 = _FlipbooksColumsRows.y;
				float2 appendResult7_g115 = (float2(temp_output_4_0_g115 , temp_output_5_0_g115));
				float totalFrames39_g115 = ( temp_output_4_0_g115 * temp_output_5_0_g115 );
				float2 appendResult8_g115 = (float2(totalFrames39_g115 , temp_output_5_0_g115));
				float4 texCoord75 = IN.ase_texcoord4;
				texCoord75.xy = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult42_g115 = clamp( texCoord75.x , 0.0001 , ( totalFrames39_g115 - 1.0 ) );
				float temp_output_35_0_g115 = frac( ( ( (float)0 + clampResult42_g115 ) / totalFrames39_g115 ) );
				float2 appendResult29_g115 = (float2(temp_output_35_0_g115 , ( 1.0 - temp_output_35_0_g115 )));
				float2 temp_output_15_0_g115 = ( ( UVFlipbookInput194.xy / appendResult7_g115 ) + ( floor( ( appendResult8_g115 * appendResult29_g115 ) ) / appendResult7_g115 ) );
				float2 temp_output_73_0 = temp_output_15_0_g115;
				float2 panner22 = ( 1.0 * _Time.y * _MainTexturePanning + temp_output_73_0);
				float4 break2_g135 = ( tex2D( _MainTex, panner22 ) * _MainTextureChannel );
				float4 appendResult11_g135 = (float4(break2_g135.x , break2_g135.y , break2_g135.z , break2_g135.w));
				float4 MainTexInfo25 = appendResult11_g135;
				...
				float4 break2_g138 = ( tex2DNode79 * _DetailMultiplyChannel );
				float4 appendResult11_g138 = (float4(break2_g138.x , break2_g138.y , break2_g138.z , break2_g138.w));
				...
				ifLocalVar106 = appendResult11_g138;
				...
				float temp_output_4_0_g114 = _FlipbooksColumsRows.x;
				float temp_output_5_0_g114 = _FlipbooksColumsRows.y;
				float2 appendResult7_g114 = (float2(temp_output_4_0_g114 , temp_output_5_0_g114));
				float totalFrames39_g114 = ( temp_output_4_0_g114 * temp_output_5_0_g114 );
				float2 appendResult8_g114 = (float2(totalFrames39_g114 , temp_output_5_0_g114));
				float clampResult42_g114 = clamp( texCoord75.x , 0.0001 , ( totalFrames39_g114 - 1.0 ) );
				float temp_output_35_0_g114 = frac( ( ( (float)0 + clampResult42_g114 ) / totalFrames39_g114 ) );
				float2 appendResult29_g114 = (float2(temp_output_35_0_g114 , ( 1.0 - temp_output_35_0_g114 )));
				float2 temp_output_15_0_g114 = ( ( ( LocalUVOffset184 + uv_AlphaOverride ) / appendResult7_g114 ) + ( floor( ( appendResult8_g114 * appendResult29_g114 ) ) / appendResult7_g114 ) );
				float2 panner44 = ( 1.0 * _Time.y * _AlphaOverridePanning + temp_output_15_0_g114);
				float4 break2_g119 = ( tex2D( _AlphaOverride, panner44 ) * _AlphaOverrideChannel );
				float AlphaOverride49 = saturate( ( break2_g119.x + break2_g119.y + break2_g119.z + break2_g119.w ) );
				float2 panner33 = ( 1.0 * _Time.y * _MainAlphaPanning + temp_output_73_0);
				float4 break2_g118 = ( tex2D( _MainTex, panner33 ) * _MainAlphaChannel );
				float MainAlpha30 = saturate( ( break2_g118.x + break2_g118.y + break2_g118.z + break2_g118.w ) );
				...
				float temp_output_3_0_g120 = ( texCoord60.w - ( 1.0 - temp_output_55_0 ) );
				...
				float Alpha = ( IN.ase_color.a * temp_output_55_0 * saturate( saturate( ( temp_output_3_0_g120 / fwidth( temp_output_3_0_g120 ) ) ) ) );
...
/*ASEBEGIN
Version=18912
524;241;1920;1029;72.8103;1232.702;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;83;-814.2831,-2017.479;Inherit;True;Property;_DetailNoise;Detail Noise;10;0;Create;True;0;0;0;False;0;False;None;3ac70e7ced6d23946ac37f602b2bc573;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;84;-560.261,-1728.191;Inherit;False;Property;_DetailNoisePanning;Detail Noise Panning;11;0;Create;True;0;0;0;False;0;False;0,0;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;74;-2538.623,-1820.153;Inherit;False;Property;_FlipbooksColumsRows;Flipbooks Colums & Rows;9;0;Create;True;0;0;0;False;0;False;1,1;1,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;73;-2289.329,-1441.295;Inherit;False;Flipbook;-1;;115;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
Node;AmplifyShaderEditor.TexturePropertyNode;27;-1997.995,-1110.504;Inherit;True;Property;_MainTex;Main Texture;0;0;Create;False;0;0;0;False;0;False;None;bd314e9939da35d4b9628adb22dfc763;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;48;-1750.768,-2290.259;Inherit;False;Property;_AlphaOverrideChannel;Alpha Override Channel;8;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;164;-1421.995,-1430.504;Inherit;False;Channel Picker Alpha;-1;;118;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;165;-1504.768,-2477.259;Inherit;False;Channel Picker Alpha;-1;;119;e49841402b321534583d1dc019041b68;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;70;365.1349,-362.5852;Inherit;False;Step Antialiasing;-1;;120;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;68;545.5906,-363.4737;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;61;710.7333,-566.5916;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;167;14.5006,-924.7495;Inherit;False;Property;_Desaturate;Desaturate?;1;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;162;183.4254,-1498.115;Inherit;False;Channel Picker;-1;;138;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.Vector4Node;87;151.4388,-2185.69;Inherit;False;Property;_DetailAdditiveChannel;Detail Additive Channel;15;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;163;-1405.995,-774.5037;Inherit;False;Channel Picker;-1;;135;dc5f4cb24a8bdf448b40a1ec5866280e;0;2;5;FLOAT4;1,0,0,0;False;7;FLOAT4;0,0,0,1;False;1;FLOAT4;0
...
WireConnection;200;2;39;0
WireConnection;200;3;40;0
ASEEND*/
//CHKSM=4C4BB56CB295B71F1D2C4B2DB6D4F6390930CFA4