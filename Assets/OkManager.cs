...
public class OkManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Ok");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.okScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.okScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.okScore, false);
        }
