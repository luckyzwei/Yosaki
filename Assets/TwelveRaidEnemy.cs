...
public class TwelveRaidEnemy : BossEnemyBase
{
    ...
    {
        //삼족오 
        if (GameManager.Instance.bossId == 23 || GameManager.Instance.bossId == 24 || GameManager.Instance.bossId == 26 || GameManager.Instance.bossId == 27 || GameManager.Instance.bossId == 28)
        {
