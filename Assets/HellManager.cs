...
public class HellManager : ContentsManagerBase
{
    [Header("BossInfo")]
    ...
    private void SetBossHp()
    {
        ...
        var prefab = Resources.Load<BossEnemyBase>($"Boss/Hell");
    ...
    private void SendScore()
    {
        ...
        if (reqValue > ServerData.userInfoTable.TableDatas[UserInfoTable.hellScore].Value)
        {
            ServerData.userInfoTable.TableDatas[UserInfoTable.hellScore].Value = reqValue;

            ServerData.userInfoTable.UpData(UserInfoTable.hellScore, false);
        }
