...
public class UiMarblePackRefund : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        if (ServerData.userInfoTable.GetTableData(UserInfoTable.marblePackChange).Value == 1) return;
        ...
        int _2DiffMarble = 500000;
        int _2DiffTicket = 5;

        int _3DiffMarble = 1000000;
        int _3DiffTicket = 10;
        ...
        ServerData.userInfoTable.TableDatas[UserInfoTable.marblePackChange].Value = 1;
        ...
        userInfoParam.Add(UserInfoTable.marblePackChange, ServerData.userInfoTable.TableDatas[UserInfoTable.marblePackChange].Value);
        ...
        ServerData.SendTransaction(transactions, successCallBack: () =>
          {
              LogManager.Instance.SendLogType("Marble", "Get", $"m:{addMarbleTotal} t:{addTicketTotal}");
