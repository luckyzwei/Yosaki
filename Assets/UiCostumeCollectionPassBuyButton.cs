...
public class UiCostumeCollectionPassBuyButton : MonoBehaviour
{
    [SerializeField]
    ...
    public static readonly string costumePassKey = "costumepass";
    ...
    private void Subscribe()
    {
        ...
        ServerData.iapServerTable.TableDatas[costumePassKey].buyCount.AsObservable().Subscribe(e =>
        {
    ...
    {
        if (ServerData.iapServerTable.TableDatas[costumePassKey].buyCount.Value >= 1)
        {
        ...
        GetPackageItem(costumePassKey);
        return;
#endif

        IAPManager.Instance.BuyProduct(costumePassKey);
    }
  ...
  public void GetPackageItem(string productId)
    {
        ...
        if (tableData.Productid != costumePassKey) return;
