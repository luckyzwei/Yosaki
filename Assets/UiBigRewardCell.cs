...
public class UiBigRewardCell : MonoBehaviour
{
    [SerializeField]
    ...
    {
        int killCountTotalWinterPass = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.killCountTotalWinterPass).Value;
        return killCountTotalWinterPass >= passInfo.require;
    }
