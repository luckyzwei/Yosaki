...
public class UiOneYearAtten : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            ServerData.userInfoTable.GetTableData(UserInfoTable.attenCountOne).Value += 1000000;
        }
    }
#endif
    ...
    {
        int killCountTotal = (int)ServerData.userInfoTable.GetTableData(UserInfoTable.attenCountOne).Value;
